...
import de.reneruck.tcd.ipp.campclient.SharedPreferences;
...
public class SendData2 implements Action, Callback {
	...
	public SendData2(TransitionExchangeBean transitionExchangeBean, SharedPreferences transitionsStore ) {
